...
class ViewController: UIViewController {
    ...
    var passCodeSettings = PassCodeSettings(passcode: false, count: 11, interval: 4.4, date: NSDate(timeIntervalSinceNow: 3600))
    ...
    @IBAction func handlerSaveButtonTap(sender: UIButton) {
        passCodeSettings = PassCodeSettings(passcode: segmentedControl.selectedSegmentIndex == 0 ? true : false, count: Int(stepper.value), interval: NSTimeInterval(textField.text!)!, date: datePicker.date)
