...
class HotelTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Add observers 
        // After change properties in: `Settings` > `General` > `Accessibility` > `Larger Text`
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(onTextSizeChange(_:)), name: UIContentSizeCategoryDidChangeNotification, object: nil)
    }
...
extension HotelTableViewController {
