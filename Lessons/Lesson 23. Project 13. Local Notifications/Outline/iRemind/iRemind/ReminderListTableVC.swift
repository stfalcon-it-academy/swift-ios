...
class ReminderListTableVC: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            let cell = tableView.dequeueReusableCellWithIdentifier("AddReminder")
            cell!.textLabel?.text = "Create New Reminder"
            
            return cell!
        }
        
        let cell = tableView.dequeueReusableCellWithIdentifier("ReminderInfo")
